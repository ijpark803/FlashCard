...
<?php 
	...
	if ( !isset($_POST['word_id']) || empty($_POST['word_id']) ) {
    ...
    else if ( !isset($_POST['search_word']) || empty($_POST['search_word']) ) {

		$error = "Please fill out a new definition";
	}
	else{
		...
		$statement = $mysqli ->prepare("UPDATE words SET defined = ? WHERE words.id = ?");

		$statement->bind_param("si", $_POST["search_word"], $_POST["word_id"]);
	...
	<div class="container-fluid pContainer">
		<div class="row">
			...
			<div class="text-success">
				<span class="font-italic">The definition was successfully edited.
			</div>
			<?php endif; ?>
